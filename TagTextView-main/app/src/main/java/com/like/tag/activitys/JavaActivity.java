...
import com.like.tag.bean.ItemBean;
import com.like.tag.R;
import com.like.tag.TestAdapter;
...
public class JavaActivity extends AppCompatActivity {
    ...
    Bitmap bitmap2;
    private TingTextViewClear image_tv1_1;

    Handler handler = new Handler(Looper.myLooper()){
        @Override
        public void handleMessage(@NonNull Message msg) {
            super.handleMessage(msg);
            BitmapPackageBean bitmapPackageBean = new BitmapPackageBean("img1", 100, 100, bitmap2);
//            image_tv1_1.setContent("你好吗？", bitmapPackageBean);
        }
    };
    ...
    private void imageStyle() {
        ...
        //测试
//        TagConfig tv1Config1_1 = new TagConfig(Type.IMAGE);
//        tv1Config1_1.setImageResource(R.mipmap.icon_new1);
//        tv1Config1_1.setPosition(3);
//        tv1Config1_1.setAlign(Align.TOP);
//
//        TextViewExKt.addTagNew(findViewById(R.id.image_tv1_1), tv1Config1_1, () -> {
//            Toast.makeText(JavaActivity.this, "被点击了", Toast.LENGTH_SHORT).show();
//            return null;
//        });
//
//        TagConfig tv1Config1_2 = new TagConfig(Type.IMAGE);
//        tv1Config1_2.setImageResource(R.mipmap.icon_new3);
//        tv1Config1_2.setPosition(5);
//        TextViewExKt.addTagNew(findViewById(R.id.image_tv1_1), tv1Config1_2);
...
//            public void run() {
//                try {
//                    URL conurl = new URL("https://img2.baidu.com/it/u=2505684809,2658429579&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500");
//                    con = (HttpURLConnection) conurl.openConnection();
//                    bitmap2 = BitmapFactory.decodeStream(con.getInputStream());
...
//        }).start();
        ...
        Bitmap bitmap1 = BitmapFactory.decodeResource(getResources(),R.mipmap.icon_new3);
        Bitmap bitmap2 = BitmapFactory.decodeResource(getResources(),R.mipmap.icon_new1);
        Bitmap bitmap3 = BitmapFactory.decodeResource(getResources(),R.mipmap.custom_img);
        Bitmap bitmap4 = BitmapFactory.decodeResource(getResources(),R.mipmap.icon_3);
        Bitmap bitmap5 = BitmapFactory.decodeResource(getResources(),R.mipmap.img1);
        BitmapPackageBean bitmapPackageBean = new BitmapPackageBean("img1", 100, 100, bitmap1);
        BitmapPackageBean bitmapPackageBean2 = new BitmapPackageBean("img1", 100, 100, bitmap2);
        BitmapPackageBean bitmapPackageBean3 = new BitmapPackageBean("img1", 100, 100, bitmap3);
        BitmapPackageBean bitmapPackageBean4 = new BitmapPackageBean("img1", 100, 100, bitmap4);
        BitmapPackageBean bitmapPackageBean5 = new BitmapPackageBean("img1", 100, 100, bitmap5);
