 ...
 */
public class NoPaddingTextViewLM extends AppCompatTextView {
    //日志标记
     ...
     * @param attrs
     */
    public NoPaddingTextViewLM(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * @param defStyleAttr
     */
    public NoPaddingTextViewLM(Context context, AttributeSet attrs, int defStyleAttr) {
